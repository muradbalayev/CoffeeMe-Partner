                        ...
                        {isAccept ? (
                            selectedTime ? (
                                ...
                                <div className='order-footer flex w-full'>
                                    ...
                                    <div className="order-footer-right w-full mt-auto mb-4 flex lg:flex-row flex-col gap-3 justify-around items-center">
                                        <div className="order-time flex items-center gap-3">
                                            <p className="text-base leading-4">Hazır olacağı <br />müddət (dəqiqə)</p>
                                            <div className="time-card flex items-center gap-2">
                                                <button onClick={() => handleTimeSelect(5)} className="font-semibold py-4 px-9 border border-gray-300 rounded-xl">5</button>
                                                <button onClick={() => handleTimeSelect(10)} className="font-semibold py-4 px-8 border border-gray-300 rounded-xl">10</button>
                                                <button onClick={() => handleTimeSelect(15)} className="font-semibold py-4 px-8 border border-gray-300 rounded-xl">15</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className='order-footer flex w-full'>
                                ...
                                <div className="order-footer-right w-full mt-auto mb-4 flex lg:flex-row flex-col gap-3 justify-around items-center ">
                                    <div className="order-price flex gap-1">
                                        <p className="text-xl leading-4">Total</p>
                                        <h4 className="text-3xl">{order.price} AZN</h4>
                                    </div>
                                    <div className="order-time w-20 h-20 border-4 rounded-full flex flex-col justify-center items-center border-green-800">
                                        <h4 className="font-semibold text-3xl">{order.timeLeft}</h4>
                                        <p className="text-xs">min</p>
                                    </div>
                                </div>
                            </div>
